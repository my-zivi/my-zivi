...
CREATE TABLE public.service_inquiries (
    ...
    email character varying NOT NULL,
    phone character varying,
    service_beginning timestamp without time zone NOT NULL,
    service_ending timestamp without time zone NOT NULL,
...
CREATE UNIQUE INDEX index_job_postings_on_slug ON public.job_postings USING btree (slug);
