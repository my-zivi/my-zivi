...
INSERT INTO `user_feedback_questions` (`id`, `created_at`, `updated_at`, `deleted_at`, `question`, `new_page`, `type`, `opt1`, `opt2`, `opt3`, `pos`, `active`) VALUES
  (1, NULL, NULL, NULL, 'Wie wurdest du auf die SWO aufmerksam ?', 0, 6, '', '', '', 1, 1),
  (2, NULL, NULL, NULL, 'Hattest du genügend Informationen zum Einsatzbetrieb ?', 0, 1, 'nein', 'ja', '', 2, 1),
  (3, NULL, NULL, NULL, 'Wie zufrieden warst du mit der Anmeldung über iZivi ?', 0, 1, 'nicht zufrieden', 'sehr zufrieden', '', 3, 1),
  (4, NULL, NULL, NULL, 'Wie zufrieden warst du mit der Spesenabrechnung ?', 0, 1, 'nicht zufrieden', 'sehr zufrieden', '', 4, 1),
  (5, NULL, NULL, NULL, 'Wie wichtig waren folgende Gründe bei deiner Wahl des Einsatzbetriebes ?', 0, 2, 'gar nicht wichtig', 'sehr wichtig', '', 5, 1),
  ...
  (11, NULL, NULL, NULL, 'Wie streng war die Arbeit ?', 1, 1, 'gar nicht streng', 'sehr streng', '', 11, 1),
  (12, NULL, NULL, NULL, 'Wie gut wurde (n) ...', 0, 2, 'sehr schlecht', 'sehr gut', '', 12, 1),
  ...
  (16, NULL, NULL, NULL, 'Wie beurteilst du den Zustand der...', 0, 2, 'sehr schlecht', 'sehr gut', '', 16, 1),
  ...
  (19, NULL, NULL, NULL, 'Wie war die Stimmung in der Gruppe während der Arbeit ?', 0, 1, 'sehr schlecht', 'sehr gut', '', 19, 1),
  (20, NULL, NULL, NULL, 'Wie fandest du die Gruppengrösse', 0, 1, 'zu klein', 'zu gross', '', 20, 1),
  (21, NULL, NULL, NULL, 'Wie sinnvoll hast du die Projekte empfunden ?', 0, 1, 'gar nicht sinnvoll', 'sehr sinnvoll', '', 21, 1),
  (22, NULL, NULL, NULL, 'Wie beurteilst du die Sicherheit während der Arbeit ?', 0, 1, 'gar nicht sicher', 'sehr sicher', '', 22, 1),
  (23, NULL, NULL, NULL, 'Waren rauchende Zivi\'s für dich ein Problem ...', 0, 2, 'gar nicht', 'sehr stark', '', 23, 1),
  (24, NULL, NULL, NULL, '- während der Arbeit ?', 0, 3, '', '', '', 24, 1),
  (25, NULL, NULL, NULL, '- während der Pausen ?', 0, 3, '', '', '', 25, 1),
  (26, NULL, NULL, NULL, 'Bist du selbst Raucher ?', 0, 5, 'nein', 'ja', '', 26, 1),
  (27, NULL, NULL, NULL, 'Wie stark stimmst du folgenden Aussagen zu ?', 1, 2, 'stimme gar nicht zu', 'stimme voll zu', '', 27, 1),
