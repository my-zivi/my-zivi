  ...
  return (
    <div className="page page__home">
      ...
      <Card>
        ...
        <ul>
          <li>
            Als zukünftiger Zivi musst du dich zuerst erkundigen, ob zum gewünschten Zeitpunkt ein Einsatz möglich ist. Erkundige dich bitte
            direkt bei{' '}
          ...
          <li>
            ...
            Einsatzleitung ein Community Passwort bekannt geben, mit welchem du dir auf dieser Seite einen Account eröffnen und die
      ...
      <Card>
        ...
        <ul>
          ...
          <li>
            Community Passwort: Mit diesem Passwort identifiziert dich das System als berechtigt einen Account zu eröffnen. Es wird dir von
            der Einsatzleitung bekannt gegeben.
          </li>
        </ul>
      </Card>
      <Card>
        ...
        <p>
          Auf dieser Seite kannst du deine persöhnlichen Daten erfassen und editieren. Primär werden diese zur Erstellung der Einsatzplanung
          benötigt. Einige andere sind uns bei der Administration des Zivi Projektes (Bsp. KontoNr.) hilfreich. Bitte fülle alle Felder
          korrekt aus. Du erleichterst uns und dir deinen Zivieinsatz. Zu folgenden Feldern einige Erläuterungen:
        </p>
        <ul>
          <li>
      ...
      <Card>
        ...
        <p>
          ...
          Zivieinsätze im Naturschutz müssen an einem Montag beginnen und an einem Freitag enden, ausser es handelt sich um deinen letzten
          Zivi Einsatz und du leistest nur noch die verbleibenden Resttage.
        </p>
      </Card>
      <Card>
