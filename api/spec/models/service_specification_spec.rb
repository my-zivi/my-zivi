...
RSpec.describe ServiceSpecification, type: :model do
  ...
  it { is_expected.to validate_presence_of :paid_vacation_expense }
  it { is_expected.to validate_presence_of :first_day_expense }
  it { is_expected.to validate_presence_of :last_day_expense }
