...
class MissionDaysCalculatorTest extends TestCase
{
    ...
    {
        return [
            [ 1, '2018-04-09', '2018-04-09'],
            [ 2, '2018-04-09', '2018-04-10'],
            [ 3, '2018-04-09', '2018-04-11'],
            [ 4, '2018-04-09', '2018-04-12'],
            [ 5, '2018-04-09', '2018-04-13'],
            [ 7, '2018-04-09', '2018-04-16'],
            [ 7, '2018-04-09', '2018-04-16'],
            [ 8, '2018-04-09', '2018-04-17'],
            [ 9, '2018-04-09', '2018-04-18'],
            [11, '2018-04-09', '2018-04-19'],
            [11, '2018-04-09', '2018-04-19'],
            [12, '2018-04-09', '2018-04-20'],
            [14, '2018-04-09', '2018-04-23'],
            [14, '2018-04-09', '2018-04-23'],
            [15, '2018-04-09', '2018-04-24'],
            [16, '2018-04-09', '2018-04-25'],
            [18, '2018-04-09', '2018-04-26'],
            [18, '2018-04-09', '2018-04-26'],
            [19, '2018-04-09', '2018-04-27'],
            [21, '2018-04-09', '2018-04-30'],
            [21, '2018-04-09', '2018-04-30'],
            [22, '2018-04-09', '2018-05-02'], // mit 1. Mai
            [24, '2018-04-09', '2018-05-03'], // mit 1. Mai
            [26, '2018-04-09', '2018-05-04'], // mit 1. Mai
            [26, '2018-04-09', '2018-05-04'], // mit 1. Mai
            [26, '2018-04-09', '2018-05-04'],
        ];
    }
    ...
    public function sampleDataForEndDate(): array
    {
        return [
            ...
            [ 4, '2018-04-09', '2018-04-12'],
            [ 5, '2018-04-09', '2018-04-13'],
            [ 6, '2018-04-09', '2018-04-16'],
            [ 7, '2018-04-09', '2018-04-16'],
            [ 8, '2018-04-09', '2018-04-17'],
            [ 9, '2018-04-09', '2018-04-18'],
            [10, '2018-04-09', '2018-04-19'],
            [11, '2018-04-09', '2018-04-19'],
            [12, '2018-04-09', '2018-04-20'],
            [13, '2018-04-09', '2018-04-23'],
            [14, '2018-04-09', '2018-04-23'],
            [15, '2018-04-09', '2018-04-24'],
            [16, '2018-04-09', '2018-04-25'],
            [17, '2018-04-09', '2018-04-26'],
            [18, '2018-04-09', '2018-04-26'],
            [19, '2018-04-09', '2018-04-27'],
            [20, '2018-04-09', '2018-04-30'],
            [21, '2018-04-09', '2018-04-30'],
            [22, '2018-04-09', '2018-05-02'], // mit 1. Mai
            [23, '2018-04-09', '2018-05-03'], // mit 1. Mai
            [24, '2018-04-09', '2018-05-04'], // mit 1. Mai
            [25, '2018-04-09', '2018-05-04'], // mit 1. Mai
            [26, '2018-04-09', '2018-05-04'],
        ];
    }
}
