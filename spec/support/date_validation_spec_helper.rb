...
RSpec.shared_examples_for 'validates that the ending is on or after beginning' do
  describe '#ending' do
    subject do
      model.tap(&:validate).errors.added? :ending, :on_or_after, restriction: beginning.strftime('%Y-%m-%d %H:%M:%S')
    end
