  ...
  module ServiceAgreement
    module FormFields
      CIVIL_SERVANT_FORM_FIELDS = [
        ...
        :health_insurance,
        {
          address: %i[zip_with_city street],
          user: %i[email],
          regional_center: %i[name]
        }
      ].freeze
      private_constant :CIVIL_SERVANT_FORM_FIELDS

      SERVICE_SPEC_FORM_FIELDS = [
        :title,
        {
          organization: [
            :eib_nr
      ...
      private_constant :SERVICE_SPEC_FORM_FIELDS
      ...
      FORM_FIELDS = [
        {
          service: [
            ...
            :ending,
            {
              civil_servant: CIVIL_SERVANT_FORM_FIELDS,
              service_specification: SERVICE_SPEC_FORM_FIELDS
            }
          ]
        }
      ].freeze
